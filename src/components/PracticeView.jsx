...
export default function PracticeView({ questions, progress, onSolve, onFail, onDraft, onExit }) {
  ...
  const [session, setSession] = useState(() => createSession(progress, questions));
    ...
    return (
      <div className="picker">
        <div className="session-done">
          ...
          <p>
            You cleared every review that was due and every new question in the queue. Come back
            tomorrow — spaced repetition will resurface these at the right time.
          </p>
